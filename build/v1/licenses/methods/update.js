...
function default_1(licenseRepo, appRepo, config) {
    return function (req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            // perform
            const object = yield licenseRepo.findOne({
                where: {
                    appId: es.arguements.appId,
                    key: es.arguements.key
                }
            });
            licenseRepo.merge(object, es.arguements.change);
            yield licenseRepo.save(object)
                .then((data) => {
