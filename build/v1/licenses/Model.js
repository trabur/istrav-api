...
const Model_2 = __importDefault(require("../plans/Model"));
...
__decorate([
    ...
    __metadata("design:type", String)
], License.prototype, "appId", void 0);
__decorate([
    typeorm_1.ManyToOne(() => Model_1.default, app => app.licenses),
    typeorm_1.JoinColumn({ name: "appId" }),
    __metadata("design:type", Model_1.default)
], License.prototype, "app", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], License.prototype, "registerId", void 0);
__decorate([
    typeorm_1.OneToOne(() => Model_1.default),
    typeorm_1.JoinColumn({ name: "registerId" }),
    __metadata("design:type", Model_1.default)
], License.prototype, "register", void 0);
__decorate([
    typeorm_1.Column({ type: "uuid", nullable: true }),
    __metadata("design:type", String)
], License.prototype, "planId", void 0);
__decorate([
    typeorm_1.ManyToOne(() => Model_2.default, plan => plan.licenses),
    typeorm_1.JoinColumn({ name: "planId" }),
    __metadata("design:type", Model_2.default)
], License.prototype, "plan", void 0);
__decorate([
    typeorm_1.Column({ type: "json", nullable: true }),
    __metadata("design:type", String)
], License.prototype, "raw", void 0);
__decorate([
    typeorm_1.Column(),
...
__decorate([
    ...
    __metadata("design:type", Date)
], License.prototype, "deletedAt", void 0);
__decorate([
    typeorm_1.Column(),
